...
if mouse_check_button_pressed(mb_left) 
{
	...
	{ 
		...
		switch(global.i_gameday)
		{
			...
			case(2):
			// day 1 group chat
				instance_create_layer(1025, 600, "Chat", obj_chat_group_1);
			break;
