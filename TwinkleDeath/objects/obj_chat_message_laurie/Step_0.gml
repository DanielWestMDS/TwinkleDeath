...
if mouse_check_button_pressed(mb_left) 
{
	...
	{ 
		...
		switch(global.i_worldday)
		{
			...
			case(2):
			// day 1 group chat
				instance_create_layer(room_width / 2, 1050, "Chat", obj_chat_laurie_1);
			break;
			
			case(3):
			// day 2 group chat
				instance_create_layer(room_width / 2, 1050, "Chat", obj_chat_laurie_2);
			break;
			
			case(4):
				instance_create_layer(room_width / 2, 1050, "Chat", obj_chat_laurie_3);
			break;
			
			case(5):
				instance_create_layer(room_width / 2, 1050, "Chat", obj_chat_laurie_4);
			break;
