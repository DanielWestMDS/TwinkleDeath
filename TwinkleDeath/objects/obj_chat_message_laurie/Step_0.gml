...
if mouse_check_button_pressed(mb_left) 
{
	...
	{ 
		...
		switch(global.i_gameday)
		{
			case(1):
				// day 0 group chat
				instance_create_layer(room_width / 2, room_height / 2, "Chat", obj_chat_laurie_0);
			break;
