...
if mouse_check_button_pressed(mb_left) 
{
	...
	{ 
		...
		switch(global.i_gameday)
		{
			...
			case(2):
			// day 1 group chat
				instance_create_layer(room_width / 2, 1200, "Chat", obj_chat_laurie_1);
			break;
